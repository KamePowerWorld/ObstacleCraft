...
dependencies {
    ...
    // ConfigLib/CommandLib
    implementation("com.github.TeamKun.CommandLib:bukkit:0.9.4")
    implementation("com.github.TeamKun.ConfigLib:bukkit:0.14.1")
    // Kotlin
